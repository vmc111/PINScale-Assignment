...
const ChartCard = () => {
  ...
  const [userCreds] = useState<Details>(useUserId());
  ...
  useEffect(() => {
    if (response !== null) {
      ...
      const inRequiredFormat = recentTxnsDateConverter(sevenDaysTxn);
  ...
  const renderSuccessView = () => {
    ...
    return (
      <div className="bg-white w-11/12 ml-5 p-3 pb-0 mb-1 rounded-2xl">
